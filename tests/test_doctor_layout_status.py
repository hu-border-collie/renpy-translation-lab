...
class DoctorRecommendationMatrixTests(unittest.TestCase):
    ...
    def test_zero_pending_with_unconfirmed_coverage_is_not_complete(self):
        report = _layout_report(
            base_dir="C:/Games/Example/work",
            rpy_files=20,
            layout_status="ready",
        ...
        report["coverage"] = {
            ...
            "reasons": ["coverage.status.block", "coverage.parse_error_candidates"],
        }
    ...
    def test_zero_pending_with_confirmed_coverage_stays_no_pending(self):
        report = _layout_report(
            base_dir="C:/Games/Example/work",
            rpy_files=20,
            layout_status="ready",
