...
# ("Dawn Chorus", "Mrs. Parker", "setlist", "B-side").
label chapter01_start:
    scene bg dorm with fade
    g "Hey [Gil_name!t], did you finish the Dawn Chorus setlist?"
    p "Almost. {i}Almost{/i} is the operative word, Gil."
    g "Mrs. Parker will flip if we're late to rehearsal again."
...
label chapter01_hall:
    ...
    g "On it! Come on, [Parker_last!t], move!"
