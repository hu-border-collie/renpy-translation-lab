...
- `{w=...}` 标签插进中文词语中间（如“瞬{w=.3}间”“阿克{w=.3}西亚”），全文件约 241 处；
- 中文与英文/数字紧贴缺空格（如“当Maeve”“好骑士Artemi”），全文件约 339 处；
- 已知机器错乱词残留（“极为钟”“略有些”“鬣人”等），全文件 7 处实锤；
- Ren'Py 标签后的英文词缀被吞进中文（如 `[[隐形仆役s]]`、`[[变形术ed]]`），全文件 2 处。
