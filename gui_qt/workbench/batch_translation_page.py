...
class BatchTranslationPage(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        heading = QLabel("批量翻译")
        heading.setObjectName("workbench_page_heading")
        heading_row.addWidget(heading)
        description = QLabel("检查项目后，提交云端任务并安全写回译文")
        description.setObjectName("workbench_page_description")
        heading_row.addWidget(description)
        heading_row.addStretch(1)
        outer.addLayout(heading_row)

        # Preserve the legacy workbench hierarchy while moving ownership on-page.
        self.main_frame = QFrame()
        self.main_frame.setObjectName("batch_primary_frame")
        ...
        self.advanced_frame.setObjectName("batch_page_advanced_frame")
        advanced_layout = QVBoxLayout(self.advanced_frame)
        advanced_layout.setContentsMargins(2, 2, 2, 0)
