...
REVIEW_WORKSPACE_COPY = {
    "open": "逐条审校",
    "tooltip": "加载当前项目语料或已有审校索引；草稿、审校决定和提案不会直接修改游戏文件。",
    "dialog_title": "选择当前项目的润色语料或审校索引 manifest",
    "title": "普通译文逐条审校（当前语料快照）",
    "empty": "选择当前项目的润色语料后加载。审校决定和草稿不会修改游戏文件。",
    "loading": "正在后台构建并加载审校索引…",
    "loaded": "当前筛选范围共 {total} 条；勾选仅作用于本页。",
    "load_error": "审校索引加载失败：",
    "draft_error": "草稿保存或读取失败：",
    "unsaved_warning": "草稿保存失败。请从详细信息复制当前编辑内容，再继续切换项目或任务。",
    "draft_saved": "草稿已保存；游戏文件尚未修改。",
    "stale_draft": "草稿绑定的证据已变化；请重新核对并保存。",
    "decision_saved": "审校决定已保存；游戏文件尚未修改。",
    "decision_error": "决定保存失败：",
    "proposal_saved": "已生成 {count} 条提案并交给现有导入校验；游戏文件尚未修改。",
    "proposal_error": "提案未生成：",
    "reviewer_required": "请填写审校者名称。",
    "selection_required": "请明确选中本页至少一条草稿。",
    "missing": "未附着证据",
    "all_files": "全部文件",
    "file_filter": "文件路径筛选",
    "lifecycles": (("全部状态", ""), ("待审", "open"), ("忽略", "ignored"),
                   ("已处理", "resolved"), ("需复核", "needs_recheck")),
    "finding_options": (("全部问题", ""), ("有问题", "yes"), ("无问题", "no")),
    "severities": (("全部严重度", ""), ("高", "high"), ("中", "medium"),
                   ("低", "low"), ("提示", "info")),
    "speaker_filter": "角色筛选",
    "query_filter": "搜索原文或译文",
    "columns": ("文件/行", "角色", "原文摘要", "当前译文摘要", "状态/问题数"),
    "previous": "上一页", "next": "下一页", "next_open": "下一待审条目",
    "page": "第 {page} 页 · 匹配 {total} 条",
    "source": "原文", "current": "当前译文", "speaker": "角色",
    "context": "前后文", "findings": "问题与建议", "provenance": "来源记录",
    "glossary": "术语证据", "decision": "审校状态与历史",
    "proposed": "建议译文", "reason": "修改原因", "reviewer": "审校者",
    "note": "审校备注", "save_draft": "保存草稿", "ignored": "标记忽略",
    "resolved": "标记已处理", "reopen": "重新打开",
    "select_page": "选择本页", "export": "选中草稿生成提案",
    "export_tooltip": "仅使用当前页明确选中的完整草稿；之后仍须经过导入校验、选择和订正预览。",
}
